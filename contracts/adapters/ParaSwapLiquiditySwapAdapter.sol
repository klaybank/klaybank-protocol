...
contract ParaSwapLiquiditySwapAdapter is BaseParaSwapSellAdapter, ReentrancyGuard {
  ...
  function executeOperation(
    ...
    IKIP7Detailed assetToSwapFrom = IKIP7Detailed(assets[0]);
    (
      IKIP7Detailed assetToSwapTo,
  ...
  function swapAndDeposit(
    ...
    IKIP7WithPermit bToken =
      IKIP7WithPermit(_getReserveData(address(assetToSwapFrom)).bTokenAddress);
