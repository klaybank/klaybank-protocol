 ...
 * @dev NOTE: THIS CONTRACT IS NOT USED WITHIN THE KLAYBANK PROTOCOL. It's an accessory contract used to reduce the number of calls
 * towards the blockchain from the Klaybank backend.
 **/
