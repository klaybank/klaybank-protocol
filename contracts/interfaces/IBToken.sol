...
interface IBToken is IKIP7, IScaledBalanceToken, IInitializableBToken {
  /**
   ...
   **/
  function getIncentivesController() external view returns (IKlaybankIncentivesController);
  ...
  /**
 * @dev Returns the address of the treasury address
   **/
