...
import {KIP13} from "../../dependencies/openzeppelin/contracts/KIP13.sol";

/**
 * @title KIP7
 * @notice Basic KIP7 implementation
 * @author Aave, inspired by the Openzeppelin KIP7 implementation
 **/
abstract contract IncentivizedKIP7 is Context, IKIP7, IKIP7Detailed, KIP13 {
   ...
   **/
  function _getIncentivesController() internal view virtual returns(IKlaybankIncentivesController);
  ...
  function _transfer(
    ...
    _balances[sender] = oldSenderBalance.sub(amount, 'KIP7: transfer amount exceeds balance');
  ...
  function _burn(address account, uint256 amount) internal virtual {
    ...
    uint256 oldAccountBalance = _balances[account];
    _balances[account] = oldAccountBalance.sub(amount, 'KIP7: burn amount exceeds balance');
